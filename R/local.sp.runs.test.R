...
#' @usage local.sp.runs.test(formula = NULL, data = NULL, na.action, fx = NULL,
...
local.sp.runs.test <-  function(formula = NULL, data = NULL, na.action, fx = NULL, distr = "asymptotic",
